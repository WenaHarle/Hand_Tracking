/*
 * Arduino Program - RIGHT HAND (5 Finger Control)
 * Port: COM4 (sesuaikan dengan koneksi Arduino kanan Anda)
 * 
 * Menerima data format: R,<Thumb>,<Index>,<Middle>,<Ring>,<Pinky>\n
 * Contoh: R,90,45,120,60,30\n
 * 
 * Pin Setup:
...
void setup() {
  ...
  Serial.println(F("READY - RIGHT HAND 5 Fingers"));
...
void handleLine(const String& line) {
  // Expected format: R,<Thumb>,<Index>,<Middle>,<Ring>,<Pinky>
  // Example: R,90,45,120,60,30
